...
SIGNAL \inst2|reg_fstate.reto~0_combout\ : std_logic;
SIGNAL \inst2|fstate.reto~q\ : std_logic;
SIGNAL \inst2|reg_fstate.virandoEsquerda~1_combout\ : std_logic;
SIGNAL \inst2|reg_fstate.virandoEsquerda~0_combout\ : std_logic;
SIGNAL \inst2|reg_fstate.virandoEsquerda~2_combout\ : std_logic;
SIGNAL \inst2|fstate.virandoEsquerda~q\ : std_logic;
SIGNAL \inst2|velMotorD~0_combout\ : std_logic;
SIGNAL \inst2|reg_fstate.virandoDireita~0_combout\ : std_logic;
SIGNAL \inst2|reg_fstate.virandoDireita~1_combout\ : std_logic;
SIGNAL \inst2|fstate.virandoDireita~q\ : std_logic;
SIGNAL \inst|Mux0~0_combout\ : std_logic;
SIGNAL \inst|Mux0~1_combout\ : std_logic;
SIGNAL \inst2|velMotorE~0_combout\ : std_logic;
...
SIGNAL \inst2|ALT_INV_velMotorD~0_combout\ : std_logic;
SIGNAL \inst|ALT_INV_Mux0~2_combout\ : std_logic;
SIGNAL \inst2|ALT_INV_velMotorE~0_combout\ : std_logic;
...
\inst2|ALT_INV_velMotorD~0_combout\ <= NOT \inst2|velMotorD~0_combout\;
\inst|ALT_INV_Mux0~2_combout\ <= NOT \inst|Mux0~2_combout\;
\inst2|ALT_INV_velMotorE~0_combout\ <= NOT \inst2|velMotorE~0_combout\;
...
-- pragma translate_on
PORT MAP (
	i => \inst2|ALT_INV_velMotorD~0_combout\,
	devoe => ww_devoe,
	o => \HEX0[6]~output_o\);
...
-- pragma translate_on
PORT MAP (
	i => \inst2|ALT_INV_velMotorE~0_combout\,
	devoe => ww_devoe,
	o => \HEX1[6]~output_o\);
...
-- Equation(s):
-- \inst1|LPM_COUNTER_component|auto_generated|counter_comb_bita20~combout\ = \inst1|LPM_COUNTER_component|auto_generated|counter_comb_bita19~COUT\ $ (!\inst1|LPM_COUNTER_component|auto_generated|counter_reg_bit\(20))
...
-- pragma translate_on
PORT MAP (
	datad => \inst1|LPM_COUNTER_component|auto_generated|counter_reg_bit\(20),
...
\inst2|reg_fstate.reto~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst2|reg_fstate.reto~0_combout\ = (\SW[1]~input_o\ & (!\SW[2]~input_o\ & \SW[0]~input_o\))
...
PORT MAP (
	...
	datac => \SW[2]~input_o\,
	datad => \SW[0]~input_o\,
	combout => \inst2|reg_fstate.reto~0_combout\);
...
PORT MAP (
	...
	d => \inst2|reg_fstate.reto~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \inst2|fstate.reto~q\);

-- Location: LCCOMB_X59_Y53_N10
\inst2|reg_fstate.virandoEsquerda~1\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst2|reg_fstate.virandoEsquerda~1_combout\ = (\SW[1]~input_o\ & (!\SW[2]~input_o\ & !\SW[0]~input_o\))
...
PORT MAP (
	...
	datac => \SW[2]~input_o\,
	datad => \SW[0]~input_o\,
	combout => \inst2|reg_fstate.virandoEsquerda~1_combout\);

-- Location: LCCOMB_X59_Y53_N16
\inst2|reg_fstate.virandoEsquerda~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst2|reg_fstate.virandoEsquerda~0_combout\ = (!\SW[2]~input_o\ & (\SW[1]~input_o\ $ (\SW[0]~input_o\)))
...
PORT MAP (
	...
	datac => \SW[2]~input_o\,
	datad => \SW[0]~input_o\,
	combout => \inst2|reg_fstate.virandoEsquerda~0_combout\);

-- Location: LCCOMB_X59_Y53_N20
\inst2|reg_fstate.virandoEsquerda~2\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst2|reg_fstate.virandoEsquerda~2_combout\ = (\inst2|reg_fstate.virandoEsquerda~1_combout\ & ((\inst2|fstate.reto~q\) # ((\inst2|reg_fstate.virandoEsquerda~0_combout\ & \inst2|fstate.virandoEsquerda~q\)))) # 
-- (!\inst2|reg_fstate.virandoEsquerda~1_combout\ & (\inst2|reg_fstate.virandoEsquerda~0_combout\ & (\inst2|fstate.virandoEsquerda~q\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \inst2|reg_fstate.virandoEsquerda~1_combout\,
	datab => \inst2|reg_fstate.virandoEsquerda~0_combout\,
	datac => \inst2|fstate.virandoEsquerda~q\,
	datad => \inst2|fstate.reto~q\,
	combout => \inst2|reg_fstate.virandoEsquerda~2_combout\);
...
PORT MAP (
	clk => \inst1|LPM_COUNTER_component|auto_generated|counter_reg_bit[20]~clkctrl_outclk\,
	d => \inst2|reg_fstate.virandoEsquerda~2_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \inst2|fstate.virandoEsquerda~q\);

-- Location: LCCOMB_X59_Y53_N4
\inst2|velMotorD~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst2|velMotorD~0_combout\ = (!\SW[2]~input_o\ & ((\inst2|fstate.reto~q\) # (\inst2|fstate.virandoEsquerda~q\)))
...
PORT MAP (
	...
	datac => \SW[2]~input_o\,
	datad => \inst2|fstate.virandoEsquerda~q\,
	combout => \inst2|velMotorD~0_combout\);

-- Location: LCCOMB_X59_Y53_N28
\inst2|reg_fstate.virandoDireita~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst2|reg_fstate.virandoDireita~0_combout\ = (!\SW[1]~input_o\ & (\SW[0]~input_o\ & (!\SW[2]~input_o\ & \inst2|fstate.reto~q\)))
...
PORT MAP (
	...
	datac => \SW[2]~input_o\,
	datad => \inst2|fstate.reto~q\,
	combout => \inst2|reg_fstate.virandoDireita~0_combout\);

-- Location: LCCOMB_X59_Y53_N22
\inst2|reg_fstate.virandoDireita~1\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst2|reg_fstate.virandoDireita~1_combout\ = (\inst2|reg_fstate.virandoDireita~0_combout\) # ((\inst2|reg_fstate.virandoEsquerda~0_combout\ & \inst2|fstate.virandoDireita~q\))
...
PORT MAP (
	...
	datad => \inst2|reg_fstate.virandoDireita~0_combout\,
	combout => \inst2|reg_fstate.virandoDireita~1_combout\);
...
PORT MAP (
	clk => \inst1|LPM_COUNTER_component|auto_generated|counter_reg_bit[20]~clkctrl_outclk\,
	d => \inst2|reg_fstate.virandoDireita~1_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \inst|Mux0~0_combout\ = (!\SW[2]~input_o\ & ((\inst2|fstate.reto~q\) # ((\inst2|fstate.virandoDireita~q\) # (\inst2|fstate.virandoEsquerda~q\))))
...
-- Equation(s):
-- \inst|Mux0~1_combout\ = (\SW[2]~input_o\) # ((\inst2|fstate.reto~q\) # ((\inst2|fstate.virandoEsquerda~q\) # (!\inst2|fstate.virandoDireita~q\)))
...
\inst2|velMotorE~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst2|velMotorE~0_combout\ = (!\SW[2]~input_o\ & ((\inst2|fstate.reto~q\) # (\inst2|fstate.virandoDireita~q\)))
...
PORT MAP (
	...
	combout => \inst2|velMotorE~0_combout\);

-- Location: LCCOMB_X59_Y53_N30
\inst|Mux0~2\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst|Mux0~2_combout\ = (\SW[2]~input_o\) # ((\inst2|fstate.reto~q\) # ((\inst2|fstate.virandoDireita~q\) # (!\inst2|fstate.virandoEsquerda~q\)))
